...
- Scout agent → Wyrd storage → federation consumer
- API boundary → agent dispatch → external data source
- New agent type → existing coordination layer → downstream tenant
